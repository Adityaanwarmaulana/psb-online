...
class Calon_Model extends CI_Model
{
  ...
  {
    $this->db->like('id_santri', $search); // Untuk menambahkan query where LIKE
    ...
    return $this->db->get('tbl_santri')->result_array(); // Eksekusi query sql sesuai kondisi diatas
  }

  public function count_all()
  {
    return $this->db->count_all('tbl_santri'); // Untuk menghitung semua data santri
  }
  ...
  public function count_filter($search)
  {
    ...
    return $this->db->get('tbl_santri')->num_rows(); // Untuk menghitung jumlah data sesuai dengan filter pada textbox pencarian
  }
}
