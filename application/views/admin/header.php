...
<body class="navbar-bottom">
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="panel_admin/">PSB <label class="label label-primary">Online</label></a>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<!-- <li class="<?php if ($sub_menu == 'profile') {
													echo 'active';
												} ?>"><a href="panel_admin/ubah_santri"><i class="icon-user"></i><span><b>DATA SANTRI</b></span></a></li> -->
								...
								<li class="<?php if ($menu == 'panel_admin' and $sub_menu == 'export') {
												echo 'active';
											} ?>"><a href="Santri"><i class="icon-file-excel"></i> <span><b>EXPORT DATA</b></span></a></li>
