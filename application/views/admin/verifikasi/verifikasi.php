        ...
        <div class="table-responsive">
          <table class="table datatable-basic table-sm table-striped" width="100%">
            ...
            <tbody>
              <?php
              $no = 1;
              foreach ($v_santri->result() as $baris) { ?>
                <tr>
                  <td><?php echo $no++; ?></td>
                  ...
                  <td align="center">
                    <!-- <a href="panel_admin/delete/<?php echo $baris->id_santri ?>" class="btn btn-default btn-xs" title="Cetak Verifikasi" target="_blank"><i class="glyphicon glyphicon-trash"></i></a> -->
