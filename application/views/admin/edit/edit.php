          ...
          <div class="panel-body">
            <fieldset class="content-group">
              ...
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label class="control-label col-lg-3">Nama Pesantren</label>
                  <div class="col-lg-9">
                    <input type="text" name="nama_lengkap" class="form-control" value="<?php echo $user->nama_lengkap; ?>" placeholder="Nama Pesantren" maxlength="100" required>
                  </div>
                </div>
                <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      <label class="control-label col-lg-3">Pengasuh Pesantren</label>
                                      <div class="col-lg-9">
                                        <input type="text" name="kepsek" class="form-control" value="<?php echo $user->kepsek; ?>" placeholder="Pengasuh Pesantren" maxlength="100" required>
                                      </div>
                                    </div>
                                    <div class="form-group">

                                      <div class="form-group">
                                        <label class="control-label col-lg-3">NIP Pengasuh Pesantren</label>
                                        <div class="col-lg-9">
                                          <input type="text" name="nip_kepsek" class="form-control" value="<?php echo $user->nip_kepsek; ?>" placeholder="NIP Pengasuh Pesantren" maxlength="100" required>
                                        </div>
                                      </div>
                                      <div class="form-group">
