...
<body onload="window.print();">
  ...
  <table width="100%" border="0">
    ...
    <tr>
      ...
      <td>:</td>
      <td><?php echo $this->lib_data->tgl_id(date('d-m-Y', strtotime($user->tgl_santri))); ?></td>
    </tr>
    <tr>
      <td>TANGGAL CETAK </td>
      <td>:</td>
    ...
    <tr>
      ...
      <td>:</td>
      <td><?php echo $user->no_hp_santri; ?></td>
    </tr>
    <tr>
      <td>ASAL SEKOLAH</td>
      <td>:</td>
  ...
  <table width="100%" border="0" style="margin-left:5px;">
    ...
    <tr>
      <td>3.</td>
      <td>Surat Keterangan Lulus dan Ijazah SD/MI <b>(*Apabila sudah ada)</b></td>
      <td>:</td>
      <td>2 lembar</td>
    </tr>
    <tr>
    ...
    <tr>
      <td valign="top">7.</td>
      <td colspan="3">Semua berkas dimasukan kedalam map biru (PUTRA), map Kuning (PUTRI) dan diserahkan kepada Panitia PSB <?php echo $id['nama_lengkap']; ?> Tahun Pelajaran <?php echo $id['th_pelajaran']; ?></td>
    </tr>
  </table>
