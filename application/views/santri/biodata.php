        ...
        <div class="panel panel-flat">
          <div class="panel-body">
            <fieldset class="content-group">
              <legend class="text-bold"><i class="icon-user"></i> Biodata Santri</legend>
              <div class="table-responsive">
                <table class="table table-bordered table-striped">
                  ...
                  <tr>
                    <th>Alamat</th>
                    <th>:</th>
                    <td><?php echo $user->alamat_santri; ?> , <?php echo $user->desa; ?> <?php echo $user->kec; ?> <?php echo $user->kab; ?> <?php echo $user->kode_pos; ?></td>
                  </tr>
                  <tr>
                    <th>No. Handphone</th>
                    <th>:</th>
        ...
        <div class="panel panel-flat">
          <div class="panel-body">
            ...
            <fieldset class="content-group">
              ...
              <?php echo $this->lib_data->tgl_id(date('d-m-Y H:i:s', strtotime($user->tgl_santri))); ?>
              <hr>
