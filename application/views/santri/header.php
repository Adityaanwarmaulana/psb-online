...
<head>
	...
	<title><?php echo $judul_web; ?> | PSB Online</title>
...
<body class="navbar-bottom <?php if ($menu == 'panel_santri' and $sub_menu == 'biodata') {
								echo 'sidebar-xs';
							} ?>">
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="panel_santri/">PSB <label class="label label-success">Online</label> </a>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown dropdown-user">
					...
					<ul class="dropdown-menu dropdown-menu-right">
						<li><a href="panel_santri/biodata"><i class="icon-user"></i> Biodata</a></li>
						<li class="divider"></li>
						<li><a href="panel_santri/logout"><i class="icon-switch2"></i> Keluar</a></li>
					</ul>
				</li>
			</ul>
		</div>
				...
				<div class=" sidebar-content">
					...
					<div class="sidebar-category sidebar-category-visible" style="background-color: white;">
						...
						<div class="category-content sidebar-user">
							<div class="media">
								<a href="panel_santri/biodata" class="media-left"><img src="img/logo.png" class="img-flat img-sm" alt="foto"></a>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class="<?php if ($menu == 'panel_santri' and $sub_menu == '') {
												echo 'active';
											} ?>"><a href="panel_santri"><i class="icon-home4"></i> <span><b>HOME</b></span></a></li>
								<li class="<?php if ($menu == 'panel_santri' and $sub_menu == 'pengumuman') {
												echo 'active';
											} ?>"><a href="panel_santri/pengumuman"><i class="glyphicon glyphicon-bullhorn"></i> <span><b>PENGUMUMAN</b></span></a></li>
								<li class="<?php if ($menu == 'panel_santri' and $sub_menu == 'biodata') {
												echo 'active';
											} ?>"><a href="panel_santri/biodata"><i class="icon-file-check2"></i> <span><b>BIODATA</b></span></a></li>

								<li><a href="panel_santri/cetak" target="_blank"><i class="icon-printer2"></i> <span><b>PRINT PENDAFTARAN</b></span></a></li>
								<!--<li><a href="panel_santri/rekap_nilai" target="_blank"><i class="icon-printer4"></i> <span>Rekap Nilai</span></a></li>-->

								<!-- /Main -->

								<!-- Data Lainnya -->
								<li class="navigation-header"><span><b>Lainnya</b></span> <i class="icon-menu" title="Data visualization"></i></li>
								<!--<li><a href="files/Panduan_PSB_Online_SMAN1_Belitang.pdf"><i class="icon-file-download2"></i> <span>Download Panduan</span></a></li>-->
								<li><a href="panel_santri/logout"><i class="icon-switch2"></i> <span><b>KELUAR</b></span></a></li>
								<!-- /Data Lainnya -->
