            ...
            <div style="margin-top:-8px;">
              <h2>
                <strong class="text-primary">
                  <a href=""><span style="margin-left:40px;color:#fff;">PSB Online</span></a>
                </strong>
              </h2>
            </div>
          </div>
      ...
      <div>
        ...
        <div class="page-content page-wizard">
          <div class="header" style="margin-top:-20px; text-align: center;">
            ...
            <h2 align="center">FORM PENDAFTARAN PSB ONLINE <strong> <br><?php echo $user['nama_lengkap']; ?></strong></h2>
                      ...
                      <form role="form" class="wizard wizard-validation" data-style="sky" role="form" action="" enctype="multipart/form-data" method="post">
                        <fieldset>
                          ...
                          <div class="col-md-8">
                            ...
                            <div class="col-md-12">
                              <span class="text-primary" style="font-size:18px;color:#222;"><strong>Apakah Anda setuju dengan ketentuan PSB Online diatas?</strong></span>
                              <div class="form-group" style="padding-bottom:30px;">
                                <div class="radio bg-success" style="padding-top:10px;padding-bottom:10px;border-radius:3px;color:#222;">
                                  <label>
                                    <input type="radio" value="cek" name="cek" data-parsley-group="block0" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="condition-ck"]' required> <b>Ya, saya menyetujui ketentuan PSB Online!</b>
                                  </label>
                            ...
                            <div class="col-md-8">
                              <div class="panel">
                                <div class="panel-heading" style="background: #275555ff; color: honeydew;">
                                  <h2 align="center" style="margin-top: 10px;">KONFIRMASI<br><b>DATA CALON SANTRI</b> </h2>
                                </div>
                                <div class="panel-body">
                                  <span style="font-size:15px">
                                    <p align="center">Proses pendaftaran PSB Online <?php echo $user['nama_lengkap']; ?> hampir selesai. <br>Silakan periksa kembali data-data yang sudah anda masukkan.</p><br><br>
                                    <div class="col-md-12">
                                      <span class="text-primary" style="font-size:18px;"><strong>Apakah data calon santri sudah sesuai?</strong></span>
            ...
            <div class="footer">
              <div class="copyright">
                ...
                <p class="pull-right sm-pull-reset">
                  <span><a href="" class="m-r-10"><i class="fa fa-home"></i> Beranda </a> | <a href="#" class="m-l-10 m-r-10" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-legal"></i> Ketentuan & Syarat PSB</a></span>
                </p>
              </div>
            </div>
          </div>
