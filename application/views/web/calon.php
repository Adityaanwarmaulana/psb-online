  ...
  <body>
    <div class="container">
      <div style="background: whitesmoke;padding: 10px;">
        <center><h1 style="margin-top: 0; "><strong>Data Pendaftar PSB <?php echo $user['nama_lengkap']; ?> Tahun Pelajaran <?php echo $user['th_pelajaran']; ?></strong></h1></center>
      </div>
      <hr>
