<div class="panel">
  <div class="panel-heading" style="background: #275555ff; color: honeydew;">
    <h2 align="center" style="margin-top: 10px;">FORM ISIAN<br><b>IDENTITAS DIRI CALON SANTRI</b> </h2>
    <!-- <hr> -->
  </div>
  <div class="panel-body">
    ...
    <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon">
        <input type="text" name="nama_lengkap" class="form-control bg-blue" placeholder="Nama lengkap Calon Santri" maxlength="100" data-parsley-group="block1" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-nama_lengkap"]' required>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select class="form-control bg-blue class" data-placeholder="Pilih Hobi Santri" name="hobi" data-parsley-group="block1" data-parsley-errors-container='div[id="error-hobi"]' required>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select class="form-control bg-blue class" data-placeholder="Pilih Cita-cita Santri" name="cita" data-parsley-group="block1" data-parsley-errors-container='div[id="error-cita"]' required>
          <option value="">Pilih cita-cita santri</option>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9 prepend-icon" style="margin-top:3px;">
        <input type="text" name="no_hp_santri" class="form-control bg-blue class" maxlength="14" onkeypress="return hanyaAngka(this);" placeholder="No. Handphone Calon Santri" data-parsley-group="block1" data-parsley-errors-container='div[id="error-no_hp_siswa"]' required>
        <i class="fa fa-phone" style="margin-left:15px;"></i>
        <div id="error-no_hp_santri" style=" background:#FFBABA; color: #D8000C; width:auto; padding-left:10px; font-size: 10px;"></div>
      </div>
    </div>
