<div class="panel">
  <div class="panel-heading" style="background: #275555ff; color: honeydew;">
    <h2 align="center" style="margin-top: 10px;">FORM ISIAN<br><b>ALAMAT CALON SANTRI</b> </h2>
    <!-- <hr> -->
  </div>
  <div class="panel-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select class="form-control bg-blue class" data-placeholder="Pilih jenis tempat tinggal" name="jenis_tinggal" data-parsley-group="block2" data-parsley-errors-container='div[id="error-jenis_tinggal"]' required>
          ...
          <option value="3">Asrama Pesantren</option>
    ...
    <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon">
        <input type="text" name="alamat_santri" class="form-control bg-blue" placeholder="Alamat santri" maxlength="100" data-parsley-group="block2" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-alamat_santri"]' required>
        <i class="fa fa-home" style="margin-left:15px;"></i>
        <div id="error-alamat_santri" style=" background:#FFBABA;color: #D8000C; width:auto;border-radius:5px;padding-left:10px;"></div>
    ...
    <div class="form-group">
      <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Jarak ke pesantren <span class="text-danger">*</span></label>
      <div class="col-sm-9" style="margin-top:3px;">
        <select class="form-control bg-blue class" data-placeholder="Jarak ke pesantren" name="jarak" data-parsley-group="block2" data-parsley-errors-container='div[id="error-jarak"]' required>
          <option value="">Pilih jarak santri ke pesantren</option>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select class="form-control bg-blue class" data-placeholder="Transportasi yang digunakan" name="trans" data-parsley-group="block2" data-parsley-errors-container='div[id="error-trans"]' required>
          <option value="">Pilih transportasi yang digunakan</option>
          ...
          <option value="5">Antar jemput</option>
